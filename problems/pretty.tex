\begin{problem}{\kcpcprobpretty\ (\kcpcprobprettyshort)}
    ...
    \end{tikzpicture}
    \end{figure}
    정점 1에서의 전위 순회는 1 \textrightarrow\ 2 \textrightarrow\ 5  \textrightarrow\ 6 \textrightarrow\ 7 \textrightarrow\ 4 \textrightarrow\ 9 \textrightarrow\ 8  \textrightarrow\ 3 \textrightarrow\ 10이고, 올바른 괄호 문자열 \verb|((())(()))|을 생성하기에 아름다운 정점이다. 
    
    정점 2에서의 전위 순회는 2 \textrightarrow\ 5  \textrightarrow\ 6 \textrightarrow\ 7으로, 올바른 괄호 문자열 \verb|(())|을 생성하기에 아름다운 정점이다.
